...
class _CartPageState extends State<CartPage> {
  ...
  Widget buildColor(AsyncSnapshot<Cart?> snapshot) {
    ...
    return Positioned.fill(
                        child: Container(
                          decoration: const BoxDecoration(color:  Color.fromARGB(255, 175, 175, 175),),
                        ),
                      );
  }
                            ...
                            ListTile(
                              ...
                              Column(children: [
                                ...
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('\Rp ${oCcy.format(item.productPrice)}',
                                    style: const TextStyle(
                                        color: Colors.black38,
                                        fontWeight: FontWeight.w200)),
                                    Text('\Rp ${oCcy.format(item.productSubtotal)}',
                                    style: TextStyle(
                                        fontSize: 15,
    ...
    return Scaffold(
        ...
        Row(
          ...
          children: [
            ...
            builder: (context, AsyncSnapshot<Cart?> snapshot) {
              if (snapshot.hasData) {
                return Padding(padding: const EdgeInsets.all(10.0), child: Text("Total : ${oCcy.format(snapshot.data?.total)}", style: const TextStyle(fontSize: 18,),));
              } else if (snapshot.hasError) {
                return const Text("");
              }
            ...
            Stack(children: [
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: !_onProgress ? const Text('Checkout') : const CircularProgressIndicator(),
                  ),
                ),
              ])   
          ],
